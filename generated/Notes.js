$(document).ready(function () {
    ...
    let tbl = $("#Notes01").DataTable({
        ...
        columns: [
        {data: 'NoteType', className: 'text-left', visible: true},
        {data: 'Code', className: 'text-left', visible: true},
        {data: 'Status', className: 'text-left', visible: true},
        {data: 'Subject', className: 'text-left', visible: true},
        {data: 'EntryDate', className: 'text-left', visible: true},
        {data: 'ActionDate', className: 'text-left', visible: true},
        {data: 'Link', className: 'text-left', visible: true},
        {data: 'NoteID', className: 'text-left', visible: true},
        {data: 'Note Detail', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#Notes01 tbody').on('click', 'td', function () {
    ...
    $('#Notes01 tbody').on( 'click', 'tr', function (){
