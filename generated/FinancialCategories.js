$(document).ready(function () {
    ...
    let tbl = $("#FinancialCategories01").DataTable({
        ...
        ajax: {
            type: 'GET',
            url: "/dbview/FinancialCategories",
        ...
        columns: [
        {data: 'FinCode', className: 'text-left', visible: true},
        {data: 'FinDesc', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#FinancialCategories01 tbody').on('click', 'td', function () {
    ...
    $('#FinancialCategories01 tbody').on( 'click', 'tr', function (){
