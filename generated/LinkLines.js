$(document).ready(function () {
    ...
    let tbl = $("#LinkLines01").DataTable({
        ...
        {data: 'Remarks', className: 'text-left', visible: true},
        {data: 'RMStore', className: 'text-left', visible: true},
        {data: 'ItemCode', className: 'text-left', visible: true},
        {data: 'RMQty', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#LinkLines01 tbody').on('click', 'td', function () {
    ...
    $('#LinkLines01 tbody').on( 'click', 'tr', function (){
