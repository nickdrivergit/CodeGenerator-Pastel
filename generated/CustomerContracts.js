$(document).ready(function () {
    ...
    let tbl = $("#CustomerContracts01").DataTable({
        ...
        {data: 'CustCode', className: 'text-left', visible: true},
        {data: 'TemplateId', className: 'text-left', visible: true},
        {data: 'StartDate', className: 'text-left', visible: true},
        {data: 'EndDate', className: 'text-left', visible: true},
        {data: 'NextDate', className: 'text-left', visible: true},
        {data: 'SalesCode', className: 'text-left', visible: true},
        {data: 'Reference', className: 'text-left', visible: true},
        {data: 'LastInvoice', className: 'text-left', visible: true},
        {data: 'LastInvoiceDate', className: 'text-left', visible: true},
        {data: 'NumInvoices', className: 'text-left', visible: true},
        {data: 'InvoicesLeft', className: 'text-left', visible: true},
        {data: 'Status', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#CustomerContracts01 tbody').on('click', 'td', function () {
    ...
    $('#CustomerContracts01 tbody').on( 'click', 'tr', function (){
