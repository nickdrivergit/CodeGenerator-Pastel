$(document).ready(function () {
    ...
    let tbl = $("#ReportCategories01").DataTable({
        ...
        columns: [
        {data: 'RCCode', className: 'text-left', visible: true},
        {data: 'RCDesc', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#ReportCategories01 tbody').on('click', 'td', function () {
    ...
    $('#ReportCategories01 tbody').on( 'click', 'tr', function (){
