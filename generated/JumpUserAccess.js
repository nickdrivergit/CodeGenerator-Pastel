$(document).ready(function () {
    ...
    let tbl = $("#JumpUserAccess01").DataTable({
        ...
        {data: 'JumpToUser', className: 'text-left', visible: true},
        {data: 'Linked', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#JumpUserAccess01 tbody').on('click', 'td', function () {
    ...
    $('#JumpUserAccess01 tbody').on( 'click', 'tr', function (){
