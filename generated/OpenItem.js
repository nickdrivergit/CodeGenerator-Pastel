$(document).ready(function () {
    ...
    let tbl = $("#OpenItem01").DataTable({
        ...
        columns: [
        {data: 'DC', className: 'text-left', visible: true},
        {data: 'Original', className: 'text-left', visible: true},
        {data: 'CSCode', className: 'text-left', visible: true},
        {data: 'MatchRef', className: 'text-left', visible: true},
        {data: 'LineFlag', className: 'text-left', visible: true},
        ...
        {data: 'Ref', className: 'text-left', visible: true},
        ...
        {data: 'CurrTaxAmt', className: 'text-left', visible: true},
        {data: 'TaxType', className: 'text-left', visible: true},
        {data: 'Discount', className: 'text-left', visible: true},
        {data: 'TaxMethodUsed', className: 'text-left', visible: true},
        {data: 'Description', className: 'text-left', visible: true},
        {data: 'UserDef', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#OpenItem01 tbody').on('click', 'td', function () {
    ...
    $('#OpenItem01 tbody').on( 'click', 'tr', function (){
