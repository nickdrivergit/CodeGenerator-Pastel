$(document).ready(function () {
    ...
    let tbl = $("#Category109901").DataTable({
        ...
        columns: [
        {data: 'Number', className: 'text-left', visible: true},
        {data: 'Description', className: 'text-left', visible: true},
        {data: 'Account', className: 'text-left', visible: true},
        {data: 'Limit', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#Category109901 tbody').on('click', 'td', function () {
    ...
    $('#Category109901 tbody').on( 'click', 'tr', function (){
