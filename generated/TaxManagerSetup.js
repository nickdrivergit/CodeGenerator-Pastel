$(document).ready(function () {
    ...
    let tbl = $("#TaxManagerSetup01").DataTable({
        ...
        columns: [
        {data: 'TaxSetupID', className: 'text-left', visible: true},
        {data: 'SecurityToken', className: 'text-left', visible: true},
        {data: 'ContactPersonName', className: 'text-left', visible: true},
        {data: 'ContactPersonSurname', className: 'text-left', visible: true},
        {data: 'Tel1', className: 'text-left', visible: true},
        {data: 'Tel2', className: 'text-left', visible: true},
        {data: 'CellPhone', className: 'text-left', visible: true},
        {data: 'ContactEmail', className: 'text-left', visible: true},
        {data: 'VATRegNo', className: 'text-left', visible: true},
        {data: 'TradingName', className: 'text-left', visible: true},
        {data: 'TaxPeriodCategory', className: 'text-left', visible: true},
        {data: 'UseOldMethod', className: 'text-left', visible: true},
        {data: 'StartMonth', className: 'text-left', visible: true},
        {data: 'Spare1', className: 'text-left', visible: true},
        {data: 'Spare2', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#TaxManagerSetup01 tbody').on('click', 'td', function () {
    ...
    $('#TaxManagerSetup01 tbody').on( 'click', 'tr', function (){
