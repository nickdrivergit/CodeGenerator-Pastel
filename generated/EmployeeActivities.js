$(document).ready(function () {
    ...
    let tbl = $("#EmployeeActivities01").DataTable({
    ...
    // Table Column Click
    $('#EmployeeActivities01 tbody').on('click', 'td', function () {
    ...
    $('#EmployeeActivities01 tbody').on( 'click', 'tr', function (){
