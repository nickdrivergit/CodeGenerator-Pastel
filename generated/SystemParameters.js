$(document).ready(function () {
    ...
    let tbl = $("#SystemParameters01").DataTable({
        ...
        {data: 'InvMsg01', className: 'text-left', visible: true},
        {data: 'InvMsg02', className: 'text-left', visible: true},
        {data: 'InvMsg03', className: 'text-left', visible: true},
        {data: 'InvMsg04', className: 'text-left', visible: true},
        {data: 'InvMsg05', className: 'text-left', visible: true},
        {data: 'InvMsg06', className: 'text-left', visible: true},
        {data: 'InvMsg07', className: 'text-left', visible: true},
        {data: 'InvMsg08', className: 'text-left', visible: true},
        {data: 'InvMsg09', className: 'text-left', visible: true},
        {data: 'InvMsg10', className: 'text-left', visible: true},
        {data: 'InvMsg11', className: 'text-left', visible: true},
        {data: 'Version', className: 'text-left', visible: true},
        {data: 'DateMask', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#SystemParameters01 tbody').on('click', 'td', function () {
    ...
    $('#SystemParameters01 tbody').on( 'click', 'tr', function (){
