$(document).ready(function () {
    ...
    let tbl = $("#ContractTemplates01").DataTable({
        ...
        {data: 'Interval', className: 'text-left', visible: true},
        {data: 'Recur', className: 'text-left', visible: true},
        {data: 'BillDay', className: 'text-left', visible: true},
        {data: 'RecurMax', className: 'text-left', visible: true},
        {data: 'BillMonth', className: 'text-left', visible: true},
        {data: 'Invoice', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#ContractTemplates01 tbody').on('click', 'td', function () {
    ...
    $('#ContractTemplates01 tbody').on( 'click', 'tr', function (){
