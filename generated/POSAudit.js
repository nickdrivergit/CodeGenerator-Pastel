$(document).ready(function () {
    ...
    let tbl = $("#POSAudit01").DataTable({
        ...
        {data: 'Reason', className: 'text-left', visible: true},
        {data: 'InvoiceNo', className: 'text-left', visible: true},
        {data: 'TransType', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#POSAudit01 tbody').on('click', 'td', function () {
    ...
    $('#POSAudit01 tbody').on( 'click', 'tr', function (){
