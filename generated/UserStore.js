$(document).ready(function () {
    ...
    let tbl = $("#UserStore01").DataTable({
        ...
        {data: 'RecordID', className: 'text-left', visible: true},
        {data: 'Access', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#UserStore01 tbody').on('click', 'td', function () {
    ...
    $('#UserStore01 tbody').on( 'click', 'tr', function (){
