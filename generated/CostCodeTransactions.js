$(document).ready(function () {
    ...
    let tbl = $("#CostCodeTransactions01").DataTable({
        ...
        ajax: {
            type: 'GET',
            url: "/dbview/CostCodeTransactions",
        ...
        {data: 'Period', className: 'text-left', visible: true},
        ...
        {data: 'TaxAmount', className: 'text-left', visible: true},
        {data: 'ThisCurrAmount', className: 'text-left', visible: true},
        {data: 'BankCurrAmount', className: 'text-left', visible: true},
        {data: 'ThisCurrTaxAmount', className: 'text-left', visible: true},
        {data: 'BankCurrTaxAmount', className: 'text-left', visible: true},
        ...
        {data: 'CostSyncLink', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#CostCodeTransactions01 tbody').on('click', 'td', function () {
    ...
    $('#CostCodeTransactions01 tbody').on( 'click', 'tr', function (){
