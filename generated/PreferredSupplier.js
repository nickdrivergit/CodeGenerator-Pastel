$(document).ready(function () {
    ...
    let tbl = $("#PreferredSupplier01").DataTable({
        ...
        {data: 'SupplierCode', className: 'text-left', visible: true},
        {data: 'SupplierRef', className: 'text-left', visible: true},
        {data: 'Preferred', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#PreferredSupplier01 tbody').on('click', 'td', function () {
    ...
    $('#PreferredSupplier01 tbody').on( 'click', 'tr', function (){
