$(document).ready(function () {
    ...
    let tbl = $("#CustomerMaster01").DataTable({
        ...
        {data: 'CustomerDesc', className: 'text-left', visible: true},
        ...
        {data: 'InterestAfter', className: 'text-left', visible: true},
        {data: 'PriceRegime', className: 'text-left', visible: true},
        ...
        {data: 'InterestPer', className: 'text-left', visible: true},
        ...
        {data: 'LoyaltyProg', className: 'text-left', visible: true},
        {data: 'LCardNumber', className: 'text-left', visible: true},
        {data: 'UpdatedOn', className: 'text-left', visible: true},
        {data: 'CashAccount', className: 'text-left', visible: true},
        {data: 'AcceptMail', className: 'text-left', visible: true},
        {data: 'CreateDate', className: 'text-left', visible: true},
        {data: 'SoleProprietor', className: 'text-left', visible: true},
        {data: 'CustName', className: 'text-left', visible: true},
        {data: 'CustSurname', className: 'text-left', visible: true},
        {data: 'CustID', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#CustomerMaster01 tbody').on('click', 'td', function () {
    ...
    $('#CustomerMaster01 tbody').on( 'click', 'tr', function (){
