$(document).ready(function () {
    ...
    let tbl = $("#MenuAccess01").DataTable({
        ...
        {data: 'MenuName', className: 'text-left', visible: true},
        {data: 'MenuIndex', className: 'text-left', visible: true},
        {data: 'MenuAllowed', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#MenuAccess01 tbody').on('click', 'td', function () {
    ...
    $('#MenuAccess01 tbody').on( 'click', 'tr', function (){
