$(document).ready(function () {
    ...
    let tbl = $("#LedgerMaster01").DataTable({
        ...
        columns: [
        {data: 'FinancialCategory', className: 'text-left', visible: true},
        {data: 'AccNumber', className: 'text-left', visible: true},
        {data: 'AccDesc', className: 'text-left', visible: true},
        {data: 'ReportWriterCategory', className: 'text-left', visible: true},
        {data: 'LinkCode', className: 'text-left', visible: true},
        {data: 'GAAPFinCat', className: 'text-left', visible: true},
        {data: 'NumberSubAccs', className: 'text-left', visible: true},
        ...
        {data: 'DefaultTax', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#LedgerMaster01 tbody').on('click', 'td', function () {
    ...
    $('#LedgerMaster01 tbody').on( 'click', 'tr', function (){
