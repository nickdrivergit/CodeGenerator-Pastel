$(document).ready(function () {
    ...
    let tbl = $("#ProcessOptions01").DataTable({
        ...
        {data: 'ProcessOption', className: 'text-left', visible: true},
        {data: 'OptionAllowed', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#ProcessOptions01 tbody').on('click', 'td', function () {
    ...
    $('#ProcessOptions01 tbody').on( 'click', 'tr', function (){
