$(document).ready(function () {
    ...
    let tbl = $("#CustomerDiscount01").DataTable({
        ...
        {data: 'Qty01', className: 'text-left', visible: true},
        {data: 'Qty02', className: 'text-left', visible: true},
        {data: 'Qty03', className: 'text-left', visible: true},
        {data: 'Price01', className: 'text-left', visible: true},
        {data: 'Price02', className: 'text-left', visible: true},
        {data: 'Price03', className: 'text-left', visible: true},
        {data: 'ExpDate', className: 'text-left', visible: true},
        {data: 'IncPrice01', className: 'text-left', visible: true},
        {data: 'IncPrice02', className: 'text-left', visible: true},
        {data: 'IncPrice03', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#CustomerDiscount01 tbody').on('click', 'td', function () {
    ...
    $('#CustomerDiscount01 tbody').on( 'click', 'tr', function (){
