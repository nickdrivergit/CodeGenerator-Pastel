$(document).ready(function () {
    ...
    let tbl = $("#GenericParameters01").DataTable({
        ...
        columns: [
        {data: 'ParmCode', className: 'text-left', visible: true},
        {data: 'LinkType', className: 'text-left', visible: true},
        {data: 'LinkAccount', className: 'text-left', visible: true},
        {data: 'Description', className: 'text-left', visible: true},
        {data: 'ColumnType', className: 'text-left', visible: true},
        {data: 'ColumnOption', className: 'text-left', visible: true},
        {data: 'CreateDate', className: 'text-left', visible: true},
        {data: 'ModifyDate', className: 'text-left', visible: true},
        {data: 'PastelVersion', className: 'text-left', visible: true},
        {data: 'DateColumn', className: 'text-left', visible: true},
        {data: 'IntegerColumn', className: 'text-left', visible: true},
        {data: 'DoubleColumn', className: 'text-left', visible: true},
        {data: 'BooleanColumn', className: 'text-left', visible: true},
        {data: 'CharColumn', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#GenericParameters01 tbody').on('click', 'td', function () {
    ...
    $('#GenericParameters01 tbody').on( 'click', 'tr', function (){
