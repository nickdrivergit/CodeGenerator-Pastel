$(document).ready(function () {
    ...
    let tbl = $("#AnalysisCodes01").DataTable({
        ...
        {data: 'AnalysisDesc', className: 'text-left', visible: true},
        {data: 'ControlAccount', className: 'text-left', visible: true},
        {data: 'IncomeAccount', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#AnalysisCodes01 tbody').on('click', 'td', function () {
    ...
    $('#AnalysisCodes01 tbody').on( 'click', 'tr', function (){
