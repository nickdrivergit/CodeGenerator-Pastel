$(document).ready(function () {
    ...
    let tbl = $("#BankDetails01").DataTable({
        ...
        {data: 'BranchName', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#BankDetails01 tbody').on('click', 'td', function () {
    ...
    $('#BankDetails01 tbody').on( 'click', 'tr', function (){
