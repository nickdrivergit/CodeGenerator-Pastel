$(document).ready(function () {
    ...
    let tbl = $("#SerialTransaction01").DataTable({
        ...
        {data: 'IncCount', className: 'text-left', visible: true},
        {data: 'IsTransfer', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#SerialTransaction01 tbody').on('click', 'td', function () {
    ...
    $('#SerialTransaction01 tbody').on( 'click', 'tr', function (){
