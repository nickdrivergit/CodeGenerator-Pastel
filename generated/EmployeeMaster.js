$(document).ready(function () {
    ...
    let tbl = $("#EmployeeMaster01").DataTable({
        ...
        {data: 'EmployeeDesc', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#EmployeeMaster01 tbody').on('click', 'td', function () {
    ...
    $('#EmployeeMaster01 tbody').on( 'click', 'tr', function (){
