$(document).ready(function () {
    ...
    let tbl = $("#InventoryCategory01").DataTable({
        ...
        columns: [
        {data: 'ICCode', className: 'text-left', visible: true},
        {data: 'ICDesc', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#InventoryCategory01 tbody').on('click', 'td', function () {
    ...
    $('#InventoryCategory01 tbody').on( 'click', 'tr', function (){
