$(document).ready(function () {
    ...
    let tbl = $("#SerialMaster01").DataTable({
        ...
        columns: [
        {data: 'SerialNumber', className: 'text-left', visible: true},
        ...
        {data: 'PrevStoreCode', className: 'text-left', visible: true},
        {data: 'PrevStatus', className: 'text-left', visible: true},
        {data: 'PrevUserID', className: 'text-left', visible: true},
        {data: 'ParentSerialNumber', className: 'text-left', visible: true},
        {data: 'ParentItemCode', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#SerialMaster01 tbody').on('click', 'td', function () {
    ...
    $('#SerialMaster01 tbody').on( 'click', 'tr', function (){
