$(document).ready(function () {
    ...
    let tbl = $("#TimesheetLines01").DataTable({
        ...
        columns: [
        {data: 'TimesheetNo', className: 'text-left', visible: true},
        {data: 'EmployeeCode', className: 'text-left', visible: true},
        {data: 'LineNo', className: 'text-left', visible: true},
        {data: 'InvoiceNo', className: 'text-left', visible: true},
        {data: 'ActivityDate', className: 'text-left', visible: true},
        {data: 'CustomerCode', className: 'text-left', visible: true},
        {data: 'CostCode', className: 'text-left', visible: true},
        {data: 'ActivityCode', className: 'text-left', visible: true},
        {data: 'StoreCode', className: 'text-left', visible: true},
        {data: 'Description', className: 'text-left', visible: true},
        {data: 'UnitsWorked', className: 'text-left', visible: true},
        {data: 'UnitsCharged', className: 'text-left', visible: true},
        {data: 'TaxType', className: 'text-left', visible: true},
        {data: 'Rate', className: 'text-left', visible: true},
        {data: 'Amount', className: 'text-left', visible: true},
        {data: 'DefaultRate', className: 'text-left', visible: true},
        {data: 'ExchangeRate', className: 'text-left', visible: true},
        {data: 'CurrenyAmount', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#TimesheetLines01 tbody').on('click', 'td', function () {
    ...
    $('#TimesheetLines01 tbody').on( 'click', 'tr', function (){
