$(document).ready(function () {
    ...
    let tbl = $("#Fonts01").DataTable({
        ...
        {data: 'FontType', className: 'text-left', visible: true},
        {data: 'PrinterName', className: 'text-left', visible: true},
        {data: 'ReportFont', className: 'text-left', visible: true},
        {data: 'ReportSize', className: 'text-left', visible: true},
        {data: 'ReportBold', className: 'text-left', visible: true},
        {data: 'Landscape', className: 'text-left', visible: true},
        {data: 'ReportUnderline', className: 'text-left', visible: true},
        {data: 'ReportItalic', className: 'text-left', visible: true},
        {data: 'HeaderFont', className: 'text-left', visible: true},
        {data: 'HeaderSize', className: 'text-left', visible: true},
        {data: 'HeaderBold', className: 'text-left', visible: true},
        {data: 'HeaderStrike', className: 'text-left', visible: true},
        {data: 'HeaderUnderline', className: 'text-left', visible: true},
        {data: 'HeaderItalic', className: 'text-left', visible: true},
        {data: 'HeaderUsebold', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#Fonts01 tbody').on('click', 'td', function () {
    ...
    $('#Fonts01 tbody').on( 'click', 'tr', function (){
