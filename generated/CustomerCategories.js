$(document).ready(function () {
    ...
    let tbl = $("#CustomerCategories01").DataTable({
        ...
        columns: [
        {data: 'CCCode', className: 'text-left', visible: true},
        {data: 'CCDesc', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#CustomerCategories01 tbody').on('click', 'td', function () {
    ...
    $('#CustomerCategories01 tbody').on( 'click', 'tr', function (){
