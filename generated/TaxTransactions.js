$(document).ready(function () {
    ...
    let tbl = $("#TaxTransactions01").DataTable({
        ...
        {data: 'FinPeriod', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#TaxTransactions01 tbody').on('click', 'td', function () {
    ...
    $('#TaxTransactions01 tbody').on( 'click', 'tr', function (){
