$(document).ready(function () {
    ...
    let tbl = $("#MobileFunctions01").DataTable({
        ...
        {data: 'ViewName', className: 'text-left', visible: true},
        {data: 'Details', className: 'text-left', visible: true},
        {data: 'FunctionType', className: 'text-left', visible: true},
        {data: 'WhereClause', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#MobileFunctions01 tbody').on('click', 'td', function () {
    ...
    $('#MobileFunctions01 tbody').on( 'click', 'tr', function (){
