$(document).ready(function () {
    ...
    let tbl = $("#CostCodeLevelLinks01").DataTable({
        ...
        {data: 'LevelNo', className: 'text-left', visible: true},
        {data: 'LevelCode', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#CostCodeLevelLinks01 tbody').on('click', 'td', function () {
    ...
    $('#CostCodeLevelLinks01 tbody').on( 'click', 'tr', function (){
