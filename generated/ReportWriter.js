$(document).ready(function () {
    ...
    let tbl = $("#ReportWriter01").DataTable({
        ...
        columns: [
        {data: 'LineNumber', className: 'text-left', visible: true},
        {data: 'Description', className: 'text-left', visible: true},
        {data: 'nNote', className: 'text-left', visible: true},
        {data: 'Col01', className: 'text-left', visible: true},
        {data: 'Col02', className: 'text-left', visible: true},
        {data: 'Col03', className: 'text-left', visible: true},
        {data: 'Col04', className: 'text-left', visible: true},
        {data: 'Col05', className: 'text-left', visible: true},
        {data: 'Col06', className: 'text-left', visible: true},
        {data: 'Col07', className: 'text-left', visible: true},
        {data: 'Col08', className: 'text-left', visible: true},
        {data: 'Col09', className: 'text-left', visible: true},
        {data: 'Col10', className: 'text-left', visible: true},
        {data: 'Col11', className: 'text-left', visible: true},
        {data: 'Col12', className: 'text-left', visible: true},
        {data: 'Col13', className: 'text-left', visible: true},
        {data: 'PageBreak', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#ReportWriter01 tbody').on('click', 'td', function () {
    ...
    $('#ReportWriter01 tbody').on( 'click', 'tr', function (){
