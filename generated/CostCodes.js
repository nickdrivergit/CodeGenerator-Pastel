$(document).ready(function () {
    ...
    let tbl = $("#CostCodes01").DataTable({
        ...
        {data: 'JCDesc', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#CostCodes01 tbody').on('click', 'td', function () {
    ...
    $('#CostCodes01 tbody').on( 'click', 'tr', function (){
