$(document).ready(function () {
    ...
    let tbl = $("#MultiStore01").DataTable({
        ...
        {data: 'DefaultStore', className: 'text-left', visible: true},
        {data: 'PostalAddress01', className: 'text-left', visible: true},
        {data: 'PostalAddress02', className: 'text-left', visible: true},
        {data: 'PostalAddress03', className: 'text-left', visible: true},
        {data: 'PostalAddress04', className: 'text-left', visible: true},
        {data: 'PostalAddress05', className: 'text-left', visible: true},
        {data: 'PhysicalAddress01', className: 'text-left', visible: true},
        {data: 'PhysicalAddress02', className: 'text-left', visible: true},
        {data: 'PhysicalAddress03', className: 'text-left', visible: true},
        {data: 'PhysicalAddress04', className: 'text-left', visible: true},
        {data: 'PhysicalAddress05', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#MultiStore01 tbody').on('click', 'td', function () {
    ...
    $('#MultiStore01 tbody').on( 'click', 'tr', function (){
