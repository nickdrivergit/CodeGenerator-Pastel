$(document).ready(function () {
    ...
    let tbl = $("#Euro01").DataTable({
        ...
        columns: [
        {data: 'EUNumCode', className: 'text-left', visible: true},
        {data: 'EUCode', className: 'text-left', visible: true},
        {data: 'Country', className: 'text-left', visible: true},
        {data: 'EUCurrency', className: 'text-left', visible: true},
        {data: 'EURate', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#Euro01 tbody').on('click', 'td', function () {
    ...
    $('#Euro01 tbody').on( 'click', 'tr', function (){
