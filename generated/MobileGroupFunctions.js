$(document).ready(function () {
    ...
    let tbl = $("#MobileGroupFunctions01").DataTable({
        ...
        ajax: {
            type: 'GET',
            url: "/dbview/MobileGroupFunctions",
        ...
        {data: 'FunctionCode', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#MobileGroupFunctions01 tbody').on('click', 'td', function () {
    ...
    $('#MobileGroupFunctions01 tbody').on( 'click', 'tr', function (){
