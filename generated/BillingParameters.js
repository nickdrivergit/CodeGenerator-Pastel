$(document).ready(function () {
    ...
    let tbl = $("#BillingParameters01").DataTable({
        ...
        {data: 'NoDecimals', className: 'text-left', visible: true},
        {data: 'Unit', className: 'text-left', visible: true},
        {data: 'Rate', className: 'text-left', visible: true},
        {data: 'InvLinked', className: 'text-left', visible: true},
        {data: 'CopyUnit', className: 'text-left', visible: true},
        {data: 'PriceRegime', className: 'text-left', visible: true},
        {data: 'CopyActivity', className: 'text-left', visible: true},
        {data: 'NoPerUser', className: 'text-left', visible: true},
        {data: 'EnterOwnNo', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#BillingParameters01 tbody').on('click', 'td', function () {
    ...
    $('#BillingParameters01 tbody').on( 'click', 'tr', function (){
