$(document).ready(function () {
    ...
    let tbl = $("#HistoryUserSetup01").DataTable({
        ...
        {data: 'UserDescription01', className: 'text-left', visible: true},
        {data: 'UserDescription02', className: 'text-left', visible: true},
        {data: 'UserDescription03', className: 'text-left', visible: true},
        {data: 'UserDescription04', className: 'text-left', visible: true},
        {data: 'UserDescription05', className: 'text-left', visible: true},
        {data: 'UserDescription06', className: 'text-left', visible: true},
        {data: 'UserDescription07', className: 'text-left', visible: true},
        {data: 'UserOption01', className: 'text-left', visible: true},
        {data: 'UserOption02', className: 'text-left', visible: true},
        {data: 'UserOption03', className: 'text-left', visible: true},
        {data: 'UserOption04', className: 'text-left', visible: true},
        {data: 'UserOption05', className: 'text-left', visible: true},
        {data: 'UserOption06', className: 'text-left', visible: true},
        {data: 'UserOption07', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#HistoryUserSetup01 tbody').on('click', 'td', function () {
    ...
    $('#HistoryUserSetup01 tbody').on( 'click', 'tr', function (){
