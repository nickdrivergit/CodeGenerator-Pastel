$(document).ready(function () {
    ...
    let tbl = $("#ReportExport01").DataTable({
        ...
        {data: 'RCol01', className: 'text-left', visible: true},
        {data: 'RCol02', className: 'text-left', visible: true},
        {data: 'RCol03', className: 'text-left', visible: true},
        {data: 'RCol04', className: 'text-left', visible: true},
        {data: 'RCol05', className: 'text-left', visible: true},
        {data: 'RCol06', className: 'text-left', visible: true},
        {data: 'RCol07', className: 'text-left', visible: true},
        {data: 'RCol08', className: 'text-left', visible: true},
        {data: 'RCol09', className: 'text-left', visible: true},
        {data: 'RCol10', className: 'text-left', visible: true},
        {data: 'RCol11', className: 'text-left', visible: true},
        {data: 'RCol12', className: 'text-left', visible: true},
        {data: 'RCol13', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#ReportExport01 tbody').on('click', 'td', function () {
    ...
    $('#ReportExport01 tbody').on( 'click', 'tr', function (){
