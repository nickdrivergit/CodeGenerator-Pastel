$(document).ready(function () {
    ...
    let tbl = $("#HistoryTax01").DataTable({
        ...
        {data: 'Address01', className: 'text-left', visible: true},
        {data: 'Address02', className: 'text-left', visible: true},
        {data: 'Address03', className: 'text-left', visible: true},
        {data: 'Address04', className: 'text-left', visible: true},
        {data: 'Address05', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#HistoryTax01 tbody').on('click', 'td', function () {
    ...
    $('#HistoryTax01 tbody').on( 'click', 'tr', function (){
