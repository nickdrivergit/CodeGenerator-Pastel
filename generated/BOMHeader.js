$(document).ready(function () {
    ...
    let tbl = $("#BOMHeader01").DataTable({
        ...
        {data: 'BOMDesc', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#BOMHeader01 tbody').on('click', 'td', function () {
    ...
    $('#BOMHeader01 tbody').on( 'click', 'tr', function (){
