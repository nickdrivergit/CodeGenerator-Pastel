$(document).ready(function () {
    ...
    let tbl = $("#CompanyParameters01").DataTable({
        ...
        {data: 'StoreElectronicDocs', className: 'text-left', visible: true},
        {data: 'Location', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#CompanyParameters01 tbody').on('click', 'td', function () {
    ...
    $('#CompanyParameters01 tbody').on( 'click', 'tr', function (){
