$(document).ready(function () {
    ...
    let tbl = $("#InternetBank01").DataTable({
        ...
        columns: [
        {data: 'AccountNo', className: 'text-left', visible: true},
        {data: 'BranchCode', className: 'text-left', visible: true},
        {data: 'AccountType', className: 'text-left', visible: true},
        {data: 'Active', className: 'text-left', visible: true},
        {data: 'GLAccCode', className: 'text-left', visible: true},
        {data: 'Statements', className: 'text-left', visible: true},
        {data: 'TransferTo', className: 'text-left', visible: true},
        {data: 'TransferFrom', className: 'text-left', visible: true},
        {data: 'AllowPayments', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#InternetBank01 tbody').on('click', 'td', function () {
    ...
    $('#InternetBank01 tbody').on( 'click', 'tr', function (){
