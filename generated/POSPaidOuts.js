$(document).ready(function () {
    ...
    let tbl = $("#POSPaidOuts01").DataTable({
        ...
        {data: 'POInOut', className: 'text-left', visible: true},
        {data: 'Reference', className: 'text-left', visible: true},
        {data: 'POSAccountNumber', className: 'text-left', visible: true},
        {data: 'Amount', className: 'text-left', visible: true},
        {data: 'AuditDate', className: 'text-left', visible: true},
        {data: 'AuditTime', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#POSPaidOuts01 tbody').on('click', 'td', function () {
    ...
    $('#POSPaidOuts01 tbody').on( 'click', 'tr', function (){
