$(document).ready(function () {
    ...
    let tbl = $("#TaxPeriods01").DataTable({
        ...
        columns: [
        {data: 'TaxPeriodID', className: 'text-left', visible: true},
        {data: 'PeriodCode', className: 'text-left', visible: true},
        {data: 'StartDate', className: 'text-left', visible: true},
        {data: 'EndDate', className: 'text-left', visible: true},
        {data: 'SubmitDate', className: 'text-left', visible: true},
        {data: 'SubmitRef', className: 'text-left', visible: true},
        {data: 'SubmitUserID', className: 'text-left', visible: true},
        {data: 'StartPeriod', className: 'text-left', visible: true},
        {data: 'EndPeriod', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#TaxPeriods01 tbody').on('click', 'td', function () {
    ...
    $('#TaxPeriods01 tbody').on( 'click', 'tr', function (){
