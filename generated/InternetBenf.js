$(document).ready(function () {
    ...
    let tbl = $("#InternetBenf01").DataTable({
        ...
        {data: 'BenfType', className: 'text-left', visible: true},
        {data: 'AccNumber', className: 'text-left', visible: true},
        {data: 'Name', className: 'text-left', visible: true},
        {data: 'BankAcc', className: 'text-left', visible: true},
        {data: 'BranchCode', className: 'text-left', visible: true},
        {data: 'OurTrnRef', className: 'text-left', visible: true},
        {data: 'BenfRef', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#InternetBenf01 tbody').on('click', 'td', function () {
    ...
    $('#InternetBenf01 tbody').on( 'click', 'tr', function (){
