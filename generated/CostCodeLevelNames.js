$(document).ready(function () {
    ...
    let tbl = $("#CostCodeLevelNames01").DataTable({
    ...
    // Table Column Click
    $('#CostCodeLevelNames01 tbody').on('click', 'td', function () {
    ...
    $('#CostCodeLevelNames01 tbody').on( 'click', 'tr', function (){
