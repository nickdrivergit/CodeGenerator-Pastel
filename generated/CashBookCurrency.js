$(document).ready(function () {
    ...
    let tbl = $("#CashBookCurrency01").DataTable({
    ...
    // Table Column Click
    $('#CashBookCurrency01 tbody').on('click', 'td', function () {
    ...
    $('#CashBookCurrency01 tbody').on( 'click', 'tr', function (){
