$(document).ready(function () {
    ...
    let tbl = $("#ActivityMaster01").DataTable({
    ...
    // Table Column Click
    $('#ActivityMaster01 tbody').on('click', 'td', function () {
    ...
    $('#ActivityMaster01 tbody').on( 'click', 'tr', function (){
