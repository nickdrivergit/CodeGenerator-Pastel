$(document).ready(function () {
    ...
    let tbl = $("#Unposted01").DataTable({
        ...
        {data: 'BatchQty', className: 'text-left', visible: true},
        {data: 'SalesOrder', className: 'text-left', visible: true},
        {data: 'PurchOrder', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#Unposted01 tbody').on('click', 'td', function () {
    ...
    $('#Unposted01 tbody').on( 'click', 'tr', function (){
