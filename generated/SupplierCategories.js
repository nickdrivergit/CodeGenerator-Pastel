$(document).ready(function () {
    ...
    let tbl = $("#SupplierCategories01").DataTable({
        ...
        columns: [
        {data: 'SCCode', className: 'text-left', visible: true},
        {data: 'SCDesc', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#SupplierCategories01 tbody').on('click', 'td', function () {
    ...
    $('#SupplierCategories01 tbody').on( 'click', 'tr', function (){
