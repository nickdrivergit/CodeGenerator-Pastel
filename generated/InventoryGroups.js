$(document).ready(function () {
    ...
    let tbl = $("#InventoryGroups01").DataTable({
        ...
        {data: 'COSAcc', className: 'text-left', visible: true},
        {data: 'Adjustment', className: 'text-left', visible: true},
        {data: 'StockCtl', className: 'text-left', visible: true},
        {data: 'Variance', className: 'text-left', visible: true},
        {data: 'PurchVariance', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#InventoryGroups01 tbody').on('click', 'td', function () {
    ...
    $('#InventoryGroups01 tbody').on( 'click', 'tr', function (){
