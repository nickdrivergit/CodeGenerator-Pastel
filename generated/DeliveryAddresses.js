$(document).ready(function () {
    ...
    let tbl = $("#DeliveryAddresses01").DataTable({
        ...
        {data: 'CustDelivCode', className: 'text-left', visible: true},
        ...
        {data: 'Cell', className: 'text-left', visible: true},
        ...
        {data: 'ContactDocs', className: 'text-left', visible: true},
        {data: 'EmailDocs', className: 'text-left', visible: true},
        {data: 'ContactStatement', className: 'text-left', visible: true},
        {data: 'EmailStatement', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#DeliveryAddresses01 tbody').on('click', 'td', function () {
    ...
    $('#DeliveryAddresses01 tbody').on( 'click', 'tr', function (){
