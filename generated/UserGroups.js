$(document).ready(function () {
    ...
    let tbl = $("#UserGroups01").DataTable({
        ...
        columns: [
        {data: 'GroupID', className: 'text-left', visible: true},
        ...
        {data: 'AutoRefreshExplore', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#UserGroups01 tbody').on('click', 'td', function () {
    ...
    $('#UserGroups01 tbody').on( 'click', 'tr', function (){
