$(document).ready(function () {
    ...
    let tbl = $("#HistoryUserDesc01").DataTable({
        ...
        {data: 'UserDef01', className: 'text-left', visible: true},
        {data: 'UserDef02', className: 'text-left', visible: true},
        {data: 'UserDef03', className: 'text-left', visible: true},
        {data: 'UserDefDate01', className: 'text-left', visible: true},
        {data: 'UserDefDate02', className: 'text-left', visible: true},
        {data: 'UserDefDate03', className: 'text-left', visible: true},
    ...
    // Table Column Click
    $('#HistoryUserDesc01 tbody').on('click', 'td', function () {
    ...
    $('#HistoryUserDesc01 tbody').on( 'click', 'tr', function (){
